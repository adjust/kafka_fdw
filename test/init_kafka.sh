...
kafka_cmd="kafka-console-producer.sh --broker-list localhost:9092 --topic "
...
kafka-topics.sh --zookeeper localhost:2181 --create --topic ${simple_topic} --partitions 1 --replication-factor 1
kafka-topics.sh --zookeeper localhost:2181 --create --topic ${topic_part4} --partitions 4 --replication-factor 1
